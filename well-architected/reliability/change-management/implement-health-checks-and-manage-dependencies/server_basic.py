...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == '/':
            ...
            message += recommendation_message (user_name, tv_show, True, response)
...
def recommendation_message (user_name, tv_show, is_custom_reco, recom_resp):
    if is_custom_reco:
    ...
    cell2 = "<b>" + tv_show + "</b>"
    cell3 = "<b>" + recom_resp + "</b>"
    reco_msg = "<table border=\"5\"><tr>" + "<td>" + cell1 + "</td>" + "<td>" + cell2 + "</td>" + "<td>" + cell3 + "</td>" + "</tr></table>"
    return reco_msg
